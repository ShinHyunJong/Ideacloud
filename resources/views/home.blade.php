        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Share</a></li>
                    <li><a href="index2.html"><i class="fa fa-circle-o"></i>Keep</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li>
                <a href="pages/widgets.html">
                    <i class="fa fa-th"></i> <span>Extras</span>
                    <span class="pull-right-container">
